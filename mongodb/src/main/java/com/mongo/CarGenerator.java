...
public class CarGenerator {
	...
	public static Car Generated(Integer id){
		...
		Car car = new Car(id, carNames[random.nextInt(carNameSize)], random.nextInt(10000), 
				random.nextInt(1000000), sessionTime, registerTime, checkTime, 
				random.nextInt(1000), random.nextInt(10000), random.nextInt(100000), 
				random.nextInt(1000), ""+(int)(random.nextDouble()*1000000), random.nextInt(5));
		return car;
	}
	...
	static class Car{
		...
		public Car(int id, String carName, Integer cityId, long price, Date sessionTime, Date registerTime,
